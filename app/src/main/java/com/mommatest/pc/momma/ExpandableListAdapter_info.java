...
public class ExpandableListAdapter_info extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter_info(Context context, ArrayList<String> groups,
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        TextView tv = (TextView) convertView.findViewById(R.id.tvChild_info);
    ...
    public View getGroupView(final int groupPosition, final boolean isExpanded, View convertView,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.group_layout_info, null);
        ...
        TextView tv = (TextView) convertView.findViewById(R.id.tvGroup_info);
